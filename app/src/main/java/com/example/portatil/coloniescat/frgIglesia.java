 ...
 * {@link frgIglesia.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link frgIglesia#newInstance} factory method to
 * create an instance of this fragment.
 */
public class frgIglesia extends Fragment {
     ...
     * @return A new instance of fragment frgIglesia.
     */
    // TODO: Rename and change types and number of parameters
    public static frgIglesia newInstance(String param1, String param2) {
        frgIglesia fragment = new frgIglesia();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_frg_iglesia, container, false);
        ...
        botoResposta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    bd.modificaResposta(3,contingutText);
                    Toast toast ;
